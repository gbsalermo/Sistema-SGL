...
public class ProjetoResponseDTO {
	...
	@Schema(description = "Situação de execução do projeto.", example = "NAO_INFORMADO")
	...
	private final Boolean possuiRecursoExterno;
	@Schema(description = "Empresa vinculada ao recurso externo, quando aplicável.")
	private final String empresaRecursoExterno;
	...
	public ProjetoResponseDTO(Projeto entity) {
		...
		this.possuiRecursoExterno = entity.getPossuiRecursoExterno();
		this.empresaRecursoExterno = entity.getEmpresaRecursoExterno();
