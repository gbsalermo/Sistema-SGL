...
public class HistoricoLaboratorioController {
	...
	public ResponseEntity<List<HistoricoLaboratorioDTO>> listarPorLaboratorio(@PathVariable Long laboratorioId){
		return ResponseEntity.ok(historicoLaboratorioService.listarPorLaboratorio(laboratorioId));
	}
	
	@GetMapping("/produto/{produtoId}")
	public ResponseEntity<List<HistoricoLaboratorioDTO>> listarProduto(@PathVariable Long produtoId){
		return ResponseEntity.ok(historicoLaboratorioService.listarPorProduto(produtoId));
	}
	
	@GetMapping("/pedido/{pedidoId}")
	public ResponseEntity<List<HistoricoLaboratorioDTO>> listarPorPedido(@PathVariable Long pedidoId){
