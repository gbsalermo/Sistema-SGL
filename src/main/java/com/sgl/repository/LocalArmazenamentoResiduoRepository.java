...
@Repository
public interface LocalArmazenamentoResiduoRepository
        extends JpaRepository<LocalArmazenamentoResiduo, Long> {

    Optional<LocalArmazenamentoResiduo>
            findByPublicIdAndUnidadePublicId(
                    UUID publicId,
                    UUID unidadePublicId
            );

    List<LocalArmazenamentoResiduo>
