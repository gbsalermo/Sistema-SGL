...
public class LocalArmazenamentoResiduoController {
	...
	@PostMapping
	public ResponseEntity<LocalArmazenamentoResiduoResponseDTO> criar(@Valid @RequestBody LocalArmazenamentoResiduoRequestDTO dto){
		
		return ResponseEntity.status(HttpStatus.CREATED).body(localArmazenamentoResiduoService.criar(dto));
	}

	@GetMapping
	public ResponseEntity<List<LocalArmazenamentoResiduoResponseDTO>>
	listarTodos(){
	...
	@PutMapping("/{id}")
	public ResponseEntity<LocalArmazenamentoResiduoResponseDTO> atualizar(@PathVariable UUID id, @Valid @RequestBody LocalArmazenamentoResiduoRequestDTO dto){
